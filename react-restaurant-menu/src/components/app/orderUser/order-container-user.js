...
import OrderViewUser from "./order-view-user"
import OrderSummaryUser from "./order-summary-user"
...
export default class OrderContainerUser extends Component {
  constructor(props) {
    super(props)
    this.state = {
      courseItems: [],
  ...
  render() {
    if (this.props.summary) {
      return (
        <div className="summary-container-user">
          <OrderSummaryUser selectedItems={this.state.selectedItems} />
